...
class ForceModel:
    ...
    def copy(self):
        ...
        """
        return ForceModel(drag=self.drag, srp=self.srp, nbody=self.nbody, gravity=self.gravity,
                          atmosphere_model=self.atmosphere_model, srp_model=self.srp_model,
                          nbody_model=self.nbody_model, gravity_model=self.gravity_model)
    ...
    def from_dict(dict):
        ...
        return ForceModel(dict["drag"], dict["srp"], dict["nbody"], dict["gravity"],
                          am, srpm, nbm, gm)
