...
class TLE:
    ...
    def to_state(self):
        ...
        """
        element_array = [self.semimajor_axis(), self.eccentricity(), self.inclination(), 
                         self.right_ascension(), self.argument_perigee(), self.true_anomaly()]
    ...
    def __str__(self):
        ...
        oe = [self.semimajor_axis(), self.eccentricity(), self.inclination(), 
              self.right_ascension(), self.argument_perigee(), self.true_anomaly()]
