...
class Duration:
    ...
    def __init__(self, days:int = 0, hours:int = 0, minutes:int = 0, seconds:int|float = 0.0):
        ...
        if isinstance(days, str):
            try:
                ...
                self._total_seconds = np.round(int(d_hms[0])*c.DAY + int(hms[0])*c.HOUR + int(hms[1])*c.MINUTE + float(hms[2]), 
                                               decimals=3)
            except:
            ...
            # Store Duration as total seconds
            self._total_seconds = np.round(days*c.DAY + hours*c.HOUR + minutes*c.MINUTE + seconds,
                                           decimals=3)
    ...
    def copy(self):
        ...
        """
        return Duration(days=self.days, hours=self.hours, minutes=self.minutes, seconds=self.seconds)
    ...
    def to_dict(self):
        ...
        return {
            "type": 'Duration',
            "total_seconds": float(self._total_seconds)
            }
    ...
    def __iadd__(self, duration):
        ...
        if not isinstance(duration, Duration):
            raise NotImplementedError(f"Iterative Addition is not defined between Durations and {type(duration)}")
    ...
    def __add__(self, duration):
        ...
        # Error checking
        if not isinstance(duration, Duration):
            raise NotImplementedError(f"Addition is not defined between Durations and {type(duration)}")
    ...
    def __isub__(self, duration):
        ...
        # Error checking
        if not isinstance(duration, Duration):
            raise NotImplementedError(f"Iterative Subtraction is not defined between Durations and {type(duration)}")
    ...
    def __sub__(self, duration):
        ...
        # Error checking
        if not isinstance(duration, Duration):
            raise NotImplementedError(f"Subtraction is not defined between Durations and {type(duration)}")
    ...
    def __imul__(self, value):
        ...
        if not isinstance(value, Duration|float|int):
            raise NotImplementedError(f"Iterative Multiplication is not defined between Durations and {type(value)}")
    ...
    def __mul__(self, value):
        ...
        # Error checking
        if not isinstance(value, Duration|float|int):
            raise NotImplementedError(f"Multiplication is not defined between Durations and {type(value)}")
    ...
    def __rmul__(self, value):
        ...
        # Error checking
        if not isinstance(value, Duration|float|int):
            raise NotImplementedError(f"Reverse Multiplication is not defined between Durations and {type(value)}")
    ...
    def __truediv__(self, value):
        ...
        # Error checking
        if not isinstance(value, Duration|float|int):
            raise NotImplementedError(f"Division is not defined between Durations and {type(value)}")
    ...
    def __rtruediv__(self, value):
        ...
        # Error checking
        if not isinstance(value, Duration|float|int):
            raise NotImplementedError(f"Riverse Division is not defined between Durations and {type(value)}")
