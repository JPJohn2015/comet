...
# --------------------------------------------------------------------------------------------------------------------------
def ymdhms_to_jd(year:int, month:int, day:int, hour:int = 0, minute:int = 0, second:float = 0.0):
...
def jd_to_gmst(jd_tt: npt.ArrayLike):
    ...
    # Calculate GMST
    gmst_asec = 67310.54841 + (876600*3600 + 864-184.812866)*T + 0.093104*(T**2) - 6.2e-6*(T**3)
