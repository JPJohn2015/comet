...
class SatelliteProperties:
    ...
    def __init__(
        ...
        if not isinstance(dry_mass, int | float) or (dry_mass < 0.0):
            raise TypeError(
                "SatelliteProperties(): dry_mass must be an integer or float greater than 0.0"
            )
        self.dry_mass = dry_mass
        if not isinstance(wet_mass, int | float) or (wet_mass < 0.0):
            raise TypeError(
                "SatelliteProperties(): wet_mass must be an integer or float greater than 0.0"
            )
        self.wet_mass = wet_mass
        if not isinstance(area, int | float) or (area < 0.0):
            raise TypeError(
                "SatelliteProperties(): area must be an integer or float greater than 0.0"
            )
        self.area = area
        if not isinstance(Cd, int | float) or (Cd < 0.0):
            raise TypeError(
                "SatelliteProperties(): Cd must be an integer or float greater than 0.0"
            )
        self.Cd = Cd
        if not isinstance(Cr, int | float) or (Cr < 0.0):
            raise TypeError(
                "SatelliteProperties(): Cr must be an integer or float greater than 0.0"
            )
        self.Cr = Cr
    ...
    def from_dict(dict):
        ...
        return SatelliteProperties(
            dict["dry_mass"], dict["wet_mass"], dict["area"], dict["Cd"], dict["Cr"]
        )
