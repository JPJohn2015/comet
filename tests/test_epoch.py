...
class TestEpoch:
    ...
    def test_epoch_julian_centuries(self):
        ...
        assert np.isclose(EPOCH_A.julian_centuries('TT'), (c.UTC_TT/c.DAY)/c.JULIAN_CENTURY, 1e-10)
        assert np.isclose(EPOCH_A.julian_centuries('TAI'), (c.UTC_TAI/c.DAY)/c.JULIAN_CENTURY, 1e-10)
